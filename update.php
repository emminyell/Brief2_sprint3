          ...
          <form action="" method="post">
            <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
              ...
              <div class="col-12">
                ...
                <textarea class="form-control" id="message" name="message" rows="3" value="<?php echo $row['description'] ?>" required></textarea>
              </div>
              <div class="col-12 col-md-6">
                <label for="phone" class="form-label">Creation Date</label>
                <div class="input-group">
                  <input type="date" class="form-control" id="date" name="date" value="<?php echo $row['date_creation'] ?>">
              <div class="col-12">
